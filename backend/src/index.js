...
const longHorizonRoutes = require('./routes/long-horizon');
const sharedInputsRoutes = require('./routes/shared-inputs');
const fieldActivitiesRoutes = require('./routes/field-activities');
const reportingRoutes = require('./routes/reporting');
const taskSuggestionsRoutes = require('./routes/task-suggestions');
const taskLifecycleRoutes = require('./routes/task-lifecycle');
...
app.use('/api', longHorizonRoutes);
app.use('/api', sharedInputsRoutes);
app.use('/api', fieldActivitiesRoutes);
app.use('/api', reportingRoutes);
app.use('/api', taskSuggestionsRoutes);
app.use('/api', taskLifecycleRoutes);
app.use('/api', calculatorsRoutes);
app.use('/api', financingRoutes);
