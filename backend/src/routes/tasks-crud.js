/**
 * Task CRUD + task inputs + task checklists.
 *
 * Split out of the former routes/calendar.js (v1.0.0 release gate). Calendar
 * events live in routes/calendar-events.js; task tags/statuses/tag-links live
 * in routes/tasks.js (mounted as taskManagerRoutes). Task lifecycle state
 * machine lives in routes/task-lifecycle.js.
 */
