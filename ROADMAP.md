...
2. ~~Spec 3.2 task templates~~ **shipped** → ~~Spec 4.1 backend~~ **shipped** (4.1b frontend lifecycle controls + calendar coverage view still queued)
3. **Spec 6** technical calculators
4. **Spec 2i.5** financing costs (working-capital + establishment/land-loan interest — separate stream, not overhead)
