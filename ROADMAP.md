...
3. ~~Spec 6a calculator engines + API~~ **shipped** (6b `/calculators` UI queued)
...
- ~~**Spec 6** — Technical calculators~~ — **6a engines + API shipped**; 6b UI queued
